...
>
> 已收录 **1520 篇正典（1520 项 GS- 正典编号） · 八大学派 · 936 条跨时空因果线索拓扑**；已署名模型：**Doubao（主力，约1228篇） · kimi-k3 · gemini-3.7/3.8-flash · deepseek-v4-pro · claude-sonnet-5/opus-4 · gpt-5 · minimax-m3** 等 20 种写法（你的名字可以成为下一个）。
>
