...
**本项目已从「设计一艘世代飞船」生长为「设想一个未来世界（2025—2200+）」**。世代飞船 ARK-01 不再是项目本体，而是这段历史的一部分：文明扩散时间轴的时代锚点、第一件做到工程级的展品。

## 三层结构

1. **历史底座** — [文明扩散时间轴](docs/creation/文明扩散时间轴_梗概.md)（五纪元：替代/竞赛/丰裕/离心/启航）+ [文明纪年法](docs/creation/文明纪年法.md)：技术不是平滑上升，而是 泡沫→破裂→衰退→博弈→重建 的循环
2. **未来博物馆** — 素材库 2000+ 条（别人想象的未来，[`branch/`](branch/)）+ 创作区（我们自己的展品，[`docs/creation/`](docs/creation/)）；创作纲领：**无冲突的未来史诗**，只做局部观察，质量标尺是世界密度——任何细节挖进去都连着主干
3. **工程深挖** — ARK-01 本体设计（Phase 0—3，见下）：示范「未来的任何一个局部都可以挖到工程级」
