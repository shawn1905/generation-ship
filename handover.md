...
- **🎉 正典 80 篇·全部带图·incoming 清空**：三批入库——①kimi-k3 新写 10 篇（GS-2031-02~GS-2846-01）②旧 7 篇 incoming（GS-2034-02/2352/2353/2354-02/2391/2617/2871）③**第二批 20 篇巨构/大场景批（GS-2035-01~GS-2892-01，20 个首开格，维度只取工程/生态/知识/经济零人文）**：小行星带产业线（2035 重定向→2047 矿样→2049 燧石点炉→2076 谷神星冶炼→2104 黑石礁半世纪代差树）、星尘监测线（2047 远巡→2078 尘网→2128 微流星网→2349 贯穿报告）、月面天梯 2078、穹顶巨城 2073、ARK-01 船台合拢 2150、生物圈舗装 2150、减速段观测 2349、异星生态圈 2650、夸父轨道镜阵 2668、导航网 2820、L2 贸易港 2892。审校：第一批 ✅4/🔧6、第二批 ✅4/🔧16，0 打回。档案舱 total_docs 80、explored 66；`check_submission --all` 80/80。commit 至 e705e7c 全部 push（其间远端 gallery 更新已 rebase）。HF 数据集已同步。
- **🎨 生图管线切换 Ark Seedream**：gemini-3.1-flash-image 配额耗尽（429 报「100h 后重置」，约 08-22 恢复）；已切火山方舟 `doubao-seedream-5-0-lite-260128`（arkcli +gen，profile agent-plan_cn-beijing_personal，--size 2560x1440，--input 参考图风格锚；注意 arkcli 调用须显式 `--modality image`）。**三条固化工艺**：①去 AI 味提示词手术（删 IMAX/Hasselblad/cinematic，注入 35mm 胶片颗粒/不完美构图/光学缺陷）②**提示词一律加 "no readable text, no signage, no national flags"**（051 美国国旗/052 英文告示/056 英文板书三次穿帮后立规；图像审核必查：国旗/语言/人种与文书设定一致性）③**Ark 出图右下角有平台强制「AI生成」水印（y≈1290-1360），入库前必须 PIL 裁成 2560x1250**。桌面 `~/Desktop/世代飞船_生图对比_20260818/`（gemini/ark/ark_v2/ark_新正典050-059/ark_巨构批060-079）留作风格对比。
