...
- **定位变更（2026-08-14 用户定调）**：项目已从「设计一艘世代飞船」生长为「设想一个未来世界（2025—2200+）」——世代飞船只是这段历史的一部分（时间轴的时代锚点、第一件工程级展品）。三层结构：历史底座（时间轴+纪年法）/ 未来博物馆（素材库+创作区）/ 工程深挖（ARK-01 本体）。README 已改，wiki 已同步
