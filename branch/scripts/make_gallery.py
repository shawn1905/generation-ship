...
<div class="controls">
  ...
  <span class="chip ship" data-filter="ship3">✧ 世代飞船级(4)</span>
  <span class="chip ship" data-filter="ship2">✧ 工程细节(3)</span>
  <span class="chip ship" data-filter="ship1">✧ 外形参考(2)</span>
  <span id="tagbox"></span>
