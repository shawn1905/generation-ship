...
.tabs {{ display: flex; gap: 10px; margin: 16px 32px 20px; flex-wrap: wrap; align-items: center; }}
.tab {{ background: #1a2240; border: 1px solid #2c3860; color: #9fb0d8; padding: 8px 18px; border-radius: 20px; cursor: pointer; font-size: 14px; user-select: none; transition: all .15s ease; white-space: nowrap; }}
.tab:hover {{ border-color: #4a5f9e; color: #d8def0; }}
.tab.active {{ background: #2b3a6e; color: #fff; border-color: #5a74bd; box-shadow: 0 0 12px rgba(90,116,189,0.35); }}
.tab b {{ color: #ffd75e; margin-left: 4px; }}
...
.chip {{ background: #151d36; border: 1px solid #2c3860; color: #9fb0d8; padding: 4px 12px; border-radius: 14px; cursor: pointer; font-size: 12px; user-select: none; }}
