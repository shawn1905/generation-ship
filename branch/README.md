...
1. **交互式画廊**：浏览器打开 `gallery.html`（纯本地文件，七区 Tab：电影 157 / 剧集 62 / 游戏 84 / 动漫 34 / 漫画 29 / 小说 25 / 原画·设定集 105，标签过滤 + 搜索 + 飞船参考分级筛选）
...
```
branch/
├── gallery.html            # 交互式画廊（本地打开，七区：电影/剧集/游戏/动漫/漫画/小说/原画·设定集）
├── movies/
